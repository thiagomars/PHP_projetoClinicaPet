...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <button action="logout.php" style="background-color: white; border-radius: 50px; height: 40px; width: auto; padding: 0 15px; font-weight: 700; color: #3057C8; border-width: 0px">
